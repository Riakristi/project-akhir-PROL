...
class tampilanAwal(tampilan_awal):
    ...
    def checkbox(self):
        global harga, varian_rasa, varian_toping, ukuran_cup
        if self.pilihanmenuUi.checkBox.isChecked():
            ukuran_cup = "SMALL"
        elif self.pilihanmenuUi.checkBox_2.isChecked():
            ukuran_cup = "MEDIUM"
    ...
    def voucher(self):
        ...
        if voucher != None:
            self.pembayaranUi.voucer_info.setText("Kode voucer berhasil")
    ...
    def cek_bayar(self):
        ...
        if status == "SUCCEEDED":
            ...
            self.pembayaranUi.voucer_info.setText("Menunggu Pembayaran")
    ...
    def struk(self):
        ...
        self.strukbeliUi.label_cup.setText(ukuran_cup)
        ...
        model2.insertDatatoDB(nama,tanggal_pembelian,ukuran_cup,varian_rasa,varian_toping,harga)
...
class rekapPenjualan(rekap_penjualan):
    ...
    def viewData(self):
        cupsizeSmall = len(model2.count_cup("SMALL"))
        cupsizeMedium = len(model2.count_cup("MEDIUM"))
        cupsizeLarge = len(model2.count_cup("LARGE"))
        print(cupsizeSmall, cupsizeMedium, cupsizeLarge)
        ...
        self.tableWidgetCupSize.setItem(0, 0, QtWidgets.QTableWidgetItem(str(cupsizeSmall)))
        self.tableWidgetCupSize.setItem(1, 0, QtWidgets.QTableWidgetItem(str(cupsizeMedium)))
        self.tableWidgetCupSize.setItem(2, 0, QtWidgets.QTableWidgetItem(str(cupsizeLarge)))
        ...
        jumlahCup = model2.jumlahCup()
        self.labelTotalPenjualan.setText("Total Penjualan Sebanyak {} Cup".format(str(len(jumlahCup))))
