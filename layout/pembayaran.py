...
class Ui_pembayaran(object):
    def setupUi(self, pembayaran):
        ...
        self.voucer_input.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.pushButton_cek = QtWidgets.QPushButton(self.voucer_frame)
        self.pushButton_cek.setObjectName("pushButton_cek")
        self.verticalLayout_3.addWidget(self.pushButton_cek)
    ...
    def retranslateUi(self, pembayaran):
        ...
        self.pushButton_cek.setText(_translate("pembayaran", "Cek Bayar"))
